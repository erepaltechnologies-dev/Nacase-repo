class NigerianStates {
  // Simple list of Nigerian states for dropdowns
  ...
  // Comprehensive map with Local Government Areas for detailed forms
  static const Map<String, List<String>> statesWithLGAs = {
